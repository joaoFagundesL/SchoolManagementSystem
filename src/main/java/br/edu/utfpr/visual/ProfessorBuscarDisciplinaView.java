...
public class ProfessorBuscarDisciplinaView extends JPanel {
	...
	public ProfessorBuscarDisciplinaView(Professor p) {
		...
		JButton btnMostrarDisciplinas = new JButton("Disciplinas Ministradas");
		...
		enviarBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				mostrarDisciplinaId(Integer.parseInt(disciplinaField.getText()), p);
			}
		});
	...
	public void mostrarDisciplinaId(Integer id, Professor p) {
		...
		if(encontrou == false) {
			...
			JOptionPane.showMessageDialog(frame, "Nenhuma disciplina ministrada com esse id!");
		}
